#ifndef ARM_UTILS_V3_H
#define ARM_UTILS_V3_H
...
class ArmUtils {
    public:
        ...
        //Whole robot variables
        std::shared_ptr<moveit_cpp::PlanningComponent> whole_planning_components_ptr;
        const moveit::core::JointModelGroup* whole_joint_model_group_ptr;

        //Aiming robot variables

    private:
        //whole robot variables
        const std::string WHOLE_PLANNING_GROUP;
